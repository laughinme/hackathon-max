...
**Текущая фаза:** Create. Шаги 1, 2 и 4 дорожной карты сделаны (ядро заявки; дома, роли, REST, уведомления; мини-приложение), тестовый деплой и мини-приложение — `https://domovoy-test.fly.dev`; план и следующий шаг — [docs/STATUS.md](docs/STATUS.md). LLM — только хостинговая по API, без дообучения ([D-007](docs/DECISIONS.md)).
