...
3. Создайте экземпляр класса Bot и передайте [токен бота](https://dev.max.ru/docs/chatbots/bots-create/manage#%D0%9F%D0%BE%D0%BB%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5%20%D1%82%D0%BE%D0%BA%D0%B5%D0%BD%D0%B0%20%D0%B1%D0%BE%D1%82%D0%B0) из его настроек (карточки) в конструктор через переменные окружения. Можно использовать библиотеку [dotenv](https://www.npmjs.com/package/dotenv)
...
Чтобы выделить в сообщениях важную информацию, используйте разные способы оформления текста — **жирный шрифт**, *курсив*, [ссылки](https://dev.max.ru/) и другое. Есть два типа форматирования — Markdown и HTML. Подробнее — [в разделе API о способах форматирования](https://dev.max.ru/docs-api/use-cases/sending-messages/text-formatting)
...
Как работать с клавиатурой через API, читайте в [разделе «Клавиатура для чат-бота»](https://dev.max.ru/docs-api/use-cases/sending-messages/keyboard)
...
![](/assets/inline_keyboard_light.png)
